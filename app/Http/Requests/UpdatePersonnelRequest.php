...
class UpdatePersonnelRequest extends FormRequest
{
    ...
    {
        return [
            'badge_number' => 'required|string|max:255|unique:personnel,badge_number,' . $this->route('personnel')->id,
            'first_name' => 'required|string|max:255',
            'last_name' => 'required|string|max:255',
            'email' => 'required|email|unique:personnel,email,' . $this->route('personnel')->id,
